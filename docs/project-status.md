...
### 模块3：结算引擎（已完成 2026-06-07）

- **4 层结算引擎** — `SettlementEngine.js`，统一子层公式，逐马加总，全场归零
- **测试验证** — `SettlementEngine.test.js`，预期 [28,-6,-4,-18] 通过
- **客户端展示** — 结算面板显示各家明细、每匹马价值、累计统计
- **UI 打磨** — 手牌锚点重构、牌河高亮、碰杠间距优化、结算面板上移
